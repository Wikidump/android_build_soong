...
func (a *AndroidApp) GenerateAndroidBuildActions(ctx android.ModuleContext) {
	...
	if ctx.ModuleName() != "framework-res" && ctx.ModuleName() != "org.etucqzs.platform-res" {
	...
	} else if ctx.ModuleName() == "org.etucqzs.platform-res" {
		// org.etucqzs.platform-res.apk is installed as system/framework/org.etucqzs.platform-res.apk
		ctx.InstallFile(android.PathForModuleInstall(ctx, "framework"), ctx.ModuleName()+".apk", a.outputFile)
